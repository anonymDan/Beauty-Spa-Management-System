...
?>
              ...
              <li><span class="fa fa-phone"></span><a href="#"> +<?php  echo $row['MobileNumber'];?></a></li>
              <li><span class="fa fa-envelope-open-o"></span><a href="mailto:infosecotw@gmail.com" class="mail">
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="row bottom-copies">
        <p class="col-lg-8 copy-footer-29">© 2058  Beauty Parlour Management System </p>
